...
Все SMTP/IMAP-пароли хранятся в зашифрованном виде (AES-256-GCM). Каждая операция шифрования использует уникальный вектор инициализации (IV). Ключ шифрования берётся из переменной `ENCRYPTION_KEY`.
